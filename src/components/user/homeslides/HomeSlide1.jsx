...
const HomeSlide1 = () => {
  return (
    <section className=" mb-10  flex flex-row-reverse  border-2 w-4/5 mx-auto mt-8 ">
      ...
      <div className="flex flex-col gap-4 justify-center mx-auto ">
        <Typography
          variant="h5"
          className="mb-2 text-sm uppercase md:text-xl"
        >
         Our Best Seller
        </Typography>
        <Typography
       ...
       Latest Arrivals
        ...
        <Link to={"/products"} className="flex text-sm font-semibold  xl:gap-2 xl:text-md items-center ">
