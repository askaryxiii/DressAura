...
const ProductCard = ({ _id, title, price, image }) => {
  return (
    <Link to={`/products/${_id}`}>
      <div className="flex flex-col  shadow-md bg-white dark:bg-gray-300 dark:text-black  rounded-lg dark:border-gray-800 min-w-60 hover:scale-105  transition duration-700 ease-in-out gap-6 py-3 justify-between items-center pt-5">
